...
(function() {
  ...
  core.mga_incipit = (function() {

    function mga_incipit(seq, tof, t0) {
    ...
    mga_incipit.prototype.set_beta = function(x) {
    ...
    mga_incipit.prototype.set_rp = function(x) {
    ...
    mga_incipit.prototype.set_tof = function(x) {
      var i, _i, _ref;
    ...
    mga_incipit.prototype.objfun = function(x) {
      ...
      for (i = _i = 1, _ref = this.seq.length; 1 <= _ref ? _i < _ref : _i > _ref; i = 1 <= _ref ? ++_i : --_i) {
        v_out = core.fb_prop(v_end_l, eph_m[i - 1].v, x[4 * i], x[1 + 4 * i] * this.seq[i - 1].radius, this.seq[i - 1].mu);
    ...
    mga_incipit.prototype.feasible = function(x) {
      var elem, i, _i, _len;
