...
function planet_ephemerides(t, moon)
{
...
function mean2eccentric(M, eccentricity)
{
	...
	E = M + eccentricity * Math.cos(M);
        Ecc_New = core.newton_raphson(E,new core.bind_kepE(M, eccentricity),new core.bind_d_kepE(eccentricity),100,TOLERANCE);
        return Ecc_New;
...
core.planet_ephemerides = planet_ephemerides;
